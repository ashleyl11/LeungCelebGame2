...
public class StartPanel extends JPanel implements ActionListener {
  ...
  public void actionPerformed(ActionEvent ae) {
    ...
    JButton clickedButt = (JButton) source;
    String buttText = clickedButt.getText();

    if (buttText.equals("Add current Celebrity")) {
    ...
    } else if ((buttText.equals("Start Celebrity Game"))){
      controller.play();
    }
  }
